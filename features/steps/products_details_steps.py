...
COLOR_OPTIONS = (By.CSS_SELECTOR, "div[class*='sc-41939763-1 efecen'] div[aria-label='Carousel'] li img")
SELECTED_COLOR = (By.CSS_SELECTOR, "div[class*='sc-41939763-1 efecen'] div")
